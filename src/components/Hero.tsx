  ...
  return (
    <section className="relative overflow-hidden pt-24 pb-16 sm:pb-20">
      ...
      <div className="relative mx-auto max-w-6xl px-6 py-10 sm:py-14 text-center">
        ...
        >
          <MacDownloadLink className="group inline-flex items-center gap-2.5 rounded-2xl bg-accent px-8 py-4 text-base font-semibold text-white shadow-glow transition-all hover:bg-accent-hover hover:shadow-[0_0_64px_-8px_rgba(255,95,61,0.5)] hover:scale-[1.02] active:scale-[0.98]">
